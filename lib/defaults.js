 ...
 * 1. Essential (Boutique / Compact)
 * 2. Professional (Medium Office / Standard Corporate)
 * 3. Enterprise (Large Campus / Multi-floor HQ)
 * 4. Signature (Bespoke / Custom Site)
 *
 * Each plan has its own editable assumptions, explicit employee allocation,
 * and clear separation between:
 * - Initial Artwork Investment
 * - Monthly Recurring Operating Costs
 * - Project / Visit-Based Delivery Costs (Curator, Installation, Logistics, Travel)
 */
export const DEFAULT_PLANS = {
  essential: {
    ...
    spaceSqFt: 1500,
    artworkCount: 3,
    artworkSource: 'plan_spec', // 'plan_spec' | 'curated'
    ...
    curator: {
      ...
      justification: 'Base curation (₹1,200) + 3 artworks (₹150) + 1,500 sq ft space (₹150)',
    },
  ...
  professional: {
    ...
    spaceSqFt: 2500,
    artworkCount: 5,
    artworkSource: 'curated', // Links to curated collection by default
    ...
    curator: {
      ...
      justification: 'Base curation (₹1,500) + 5 artworks (₹300) + 2,000 sq ft space (₹200) = ₹2,000 project fee',
    },
  ...
  enterprise: {
    ...
    curator: {
      ...
      justification: 'Base curation (₹2,000) + 12 artworks (₹1,000) + 6,000 sq ft space (₹500) = ₹3,500 project fee',
    },
    installation: { feePerCycle: 3500, cycles: 1 },
    logistics: { feePerCycle: 2500, cycles: 1, basis: 'project' },
    projectTravel: { feePerCycle: 1200, cycles: 1 },
    otherProjectCosts: [],
  },
  signature: {
    id: 'signature',
    ...
    installation: { feePerCycle: 2500, cycles: 1 },
    logistics: { feePerCycle: 1800, cycles: 1, basis: 'project' },
    projectTravel: { feePerCycle: 1000, cycles: 1 },
    otherProjectCosts: [],
  },
};
